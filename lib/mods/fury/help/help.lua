...
ingame_help
{
	...
	["desc"] =
	{
		...
		"The first place you can explore is the Barrow-downs: go to the west of town",
		...
		"If you do not want me to bother you anymore with tips, press = then 5 for",
		"ToME options and deactivate the ingame_help option.",
	...
	["fct"] =       function(typ, name)
			...
			local t =
			{
				...
				["subrace"] =
				{
					...
					["Air"] = {"rm_air.txt", 0 },
					["Ancient"] = {"rm_ancient.txt", 0 },
					["Aragorn"] = { "rm_aragorn.txt", 0 },
					["Baby"] = {"rm_baby.txt", 0 },
					["Barbarian"] = { "rm_barb.txt", 0 },
					["Black"] = {"rm_black.txt", 0 },
					["Blessed"] = {"rm_blessed.txt", 0 },
					["Blue"] = {"rm_blue.txt", 0 },
					...
					["Earth"] = {"rm_earth.txt", 0 },
					["Ethereal"] = {"rm_ether.txt", 0 },
					["Ethereal"] = {"rm_ethereal.txt", 0 },
					["Favoured"] = {"rm_favoured.txt", 0 },
					["Fire"] = {"rm_fire.txt", 0 },
					["Frodo"] = { "rm_frodo.txt", 0 },
					["Gimli"] = { "rm_gimli.txt", 0 },
					["Green"] = {"rm_green.txt", 0 },
					["Hermit"] = { "rm_herm.txt", 0 },
					["(Hurog)"] = {"rm_hurog.txt", 0 },
					["Legolas"] = { "rm_legolas.txt", 0 },
					["(Limrog)"] = {"rm_limrog.txt", 0 },
					["LostSoul"] = { "rm_lsoul.txt", 0 },
					["(Lygrog)"] = {"rm_lygrog.txt", 0 },
					["Mutant"] = {"rm_mutant.txt", 0 },
					["(Narrog)"] = {"rm_narrog.txt", 0 },
					["Outcast"] = {"rm_outcast.txt", 0 },
					["Pippin"] = { "rm_pippin.txt", 0 },
